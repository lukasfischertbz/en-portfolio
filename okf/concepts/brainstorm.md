...
- What tasks do you carry out on a regular basis?
  ...
  > Comunicate with others, code features, refactor code, document code, experiment

- Which of these is a complex task?

  > Coding features is the most complex task

- Why do you like or dislike doing this task?

  > I like it when I learn something I can use for me personaly

- How do you manage this complex task?

  > I use AI for research and when I dont understand the code.
  > I ask others for help.

- How can you organise clear and effective explanations of a complex task for your classmate?

  > I like to talk to peaple in person and use documentation.

- What are the dos and the don’ts with regard to this task?

  > **Dos**
  > Be sure all the details are agreed upon so you
  > don't have to redo or undo what you have coded.
...
- What issues would you have to deal with if you forgot an essential step of your complex task?
  ...
  > If there is no clear vision, people will never say if a task is actually finished.
  > If there is a library already accesable for you Task use that instead of making things manualy.

- What skills do you need to complete these tasks?

  > Talk to people, look for alternatives.
